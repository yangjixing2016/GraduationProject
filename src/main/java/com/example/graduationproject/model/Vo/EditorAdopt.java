...
public class EditorAdopt {
    ...
    private ArrayList<AuditAdoptAudit> auditAdoptAudits;
    ...
    public ArrayList<AuditAdoptAudit> getAuditAdoptAudits() {
        return auditAdoptAudits;
    }

    public void setAuditAdoptAudits(ArrayList<AuditAdoptAudit> auditAdoptAudits) {
        this.auditAdoptAudits = auditAdoptAudits;
    }
